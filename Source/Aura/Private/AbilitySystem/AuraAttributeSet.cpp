...
void UAuraAttributeSet::PostAttributeChange(const FGameplayAttribute& Attribute, float OldValue, float NewValue)
{
	...
	// ѕосле повышени€ уровн€ значени€ MaxHealth и MaxMana будут изменены по Curve Table
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	{
		const float LoacalIncomingXP = GetIncomingXP();
		SetIncomingXP(0.f);
		...
		if (Props.SourceCharacter->Implements<UPlayerInterface>() && Props.SourceCharacter->Implements<UCombatInterface>())
		{
			...
			const int32 NewLevel = IPlayerInterface::Execute_FindLevelForXP(Props.SourceCharacter, CurrentXP + LoacalIncomingXP);
			...
			IPlayerInterface::Execute_AddToXP(Props.SourceCharacter, LoacalIncomingXP);
		}
	}
}

void UAuraAttributeSet::ShowFloatingText(FEffectProperties& Props, const float& Damage, bool bBlockedHit, bool bCriticalHit) const
{
...
void UAuraAttributeSet::ClampAttributeValue(const FGameplayAttribute& Attribute, float& NewValue) const
{
...
// Replication for Primary Attributes
...
// Replication for Secondary Attributes
...
// Replication for Resistance Attributes
...
// Replication for Vital Attributes
